...
select * from  Customersinfo where customerid  in(
select distinct customerid from Accountinfo)

--list who dont have accounts

select * from  Customersinfo where customerid not in(
select distinct customerid from Accountinfo)

--lits who have transactions

select * from  Accountinfo where Accountid  in(
select distinct Accountid from Transactioninfo)

--list who dont have transactions
